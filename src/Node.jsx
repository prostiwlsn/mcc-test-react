    ...
    <>
      <div className="mt-1 flex flex-col">
        <div className="flex flex-row align-middle group">
          ...
          <button className="opacity-15 hover:!opacity-100 group-hover:opacity-40 hover:text-amber-300 hover:border-amber-300" onClick={() => setEditNodeValue(!editNodeValue)}>
            Edit
          </button>
